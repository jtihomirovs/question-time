...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    # overwrite the perform_create method to automatically add author to record
...
class AnswerLikeAPIView(APIView):
    ...
    def post(self, request, pk):
        ...
        # pass ir post request object
        # returning the serialized data for that answer
